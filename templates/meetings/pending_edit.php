	...
	<p>
		<table border="0" class="tableMain">
			...
			<tr>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'eventName'] ) ) echo ' class="error"'; ?>><input name="eventName" type="text" id="eventName" value="<?php echo $externals['eventName']; ?>" size="64" maxlengtr="255"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'numAttend'] ) ) echo ' class="error"'; ?>><input name="numAttend" type="text" id="numAttend" value="<?php echo $externals['numAttend']; ?>" size="3" maxlengtr="3"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'desc'] ) ) echo ' class="error"'; ?>>
					<textarea cols="60" rows="5" id="desc" name="desc"><?php echo htmlspecialchars_decode( $externals['desc'] ); ?>
					</textarea>
					</td>
			</tr>
			<tr>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactName'] ) ) echo ' class="error"'; ?>><input name="contactName" type="text" id="contactName" value="<?php echo $externals['contactName']; ?>" size="32" maxlengtr="64"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactPhonePrimary'] ) ) echo ' class="error"'; ?>><input name="contactPhonePrimary" type="text" id="contactPhonePrimary" value="<?php echo $externals['contactPhonePrimary']; ?>" size="14" maxlengtr="14"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactPhoneSecondary'] ) ) echo ' class="error"'; ?>><input name="contactPhoneSecondary" type="text" id="contactPhoneSecondary" value="<?php echo $externals['contactPhoneSecondary']; ?>" size="14" maxlengtr="14"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactAddress1'] ) ) echo ' class="error"'; ?>><input name="contactAddress1" type="text" id="contactAddress1" value="<?php echo $externals['contactAddress1']; ?>" size="64" maxlengtr="255"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td><input name="contactAddress2" type="text" id="contactAddress2" value="<?php echo $externals['contactAddress2']; ?>" size="64" maxlengtr="255"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactCity'] ) ) echo ' class="error"'; ?>><input name="contactCity" type="text" id="contactCity" value="<?php echo $externals['contactCity']; ?>" maxlengtr="255"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactState'] ) ) echo ' class="error"'; ?>>
					...
					<?php
						...
						?>
					<input name="contactState" type="text" id="contactCity" value="<?php echo $externals['contactState']; ?>" name="contactCity" maxlengtr="255"/>
					<?php
					}
					?>
					</td>
			...
			<tr>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactZip'] ) ) echo ' class="error"'; ?>><input name="contactZip" type="text" id="contactZip" value="<?php echo $externals['contactZip']; ?>" size="10" maxlengtr="10"/>
					</td>
			</tr>
			<tr>
				<td>
				...
				<td<?php if( !empty( $errorArr[ 'errorBG'][ 'contactEmail'] ) ) echo ' class="error"'; ?>><input name="contactEmail" type="text" id="contactEmail" value="<?php echo $externals['contactEmail']; ?>" size="64" maxlengtr="255"/>
					</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td><input name="contactWebsite" type="text" id="contactWebsite" value="<?php echo $externals['contactWebsite']; ?>" size="64" maxlengtr="255"/>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td><input name="libcardNum" type="text" id="libcardNum" value="<?php echo $externals['libcardNum']; ?>" size="64" maxlengtr="255"/>
				</td>
			</tr>
			<tr>
