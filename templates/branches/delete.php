	...
	<tr>
		<td valign="top">
			...
			if ( $s_key == NULL ) {
				...
				?>
			<a href="/wp-admin/admin.php?page=bookaroom_Settings_RoomCont&amp;&amp;roomContID=<?php echo $s_key; ?>&amp;action=edit">
				<?php echo $s_val['name']; ?>
			</a>
			<?php
			}
		...
		<td>
			...
			foreach ( $s_val[ 'rooms' ] as $r_val ) {
				?>
			<a href="/wp-admin/admin.php?page=bookaroom_Settings_Rooms&amp;branchID=<?php echo $branchInfo['branchID']; ?>&amp;roomID=<?php echo $r_val; ?>&amp;action=edit">
...
<h3><a class="errorText" href="?page=bookaroom_Settings_Branches&amp;branchID=<?php echo $branchInfo['branchID']; ?>&amp;action=deleteCheck"><?php _e( 'Click here to permanantly delete this branch.', 'book-a-room' ); ?></a></h3>